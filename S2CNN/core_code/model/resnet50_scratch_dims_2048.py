...
class Resnet50_scratch(nn.Module):
    ...
    def forward(self, data):
        red, green, blue = data.split(1, dim=1)
        data = torch.cat([blue - 131.0912, green - 103.8827, red - 91.4953], dim=1)
...
#         classifier = classifier_preflatten.view(classifier_preflatten.size(0), -1)
        return conv5_3x, pool5_7x7_s1.view(-1, 2048)

def resnet50_scratch(weights_path=None, **kwargs):
    """
